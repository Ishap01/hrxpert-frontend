...
const Add = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 bg-white p-6 sm:p-8 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-teal-400 focus:outline-none"
              required
            />
          </div>
